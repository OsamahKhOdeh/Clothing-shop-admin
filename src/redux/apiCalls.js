import { loginFailure, loginStart, loginSuccess, logoutStart, logoutSuccess, logoutFailure, getUsersStart, getUserstSuccess, getUsersFailure } from "./userRedux";
...
export const getUsers = async (dispatch) => {
  ...
  try {
    ...
    dispatch(getUserstSuccess(res.data));
